...
public class ImpressaoBO {
    ...
    public static byte[] obterTermoManifestacaoOfendido(String ocrnum, String ocrdat, String nomeOfendido, String autoridadePM, String nomeMunicipio, String enderecoForum, String dataMarcada, String tipoManifestacao) {
        String retorno = null;
        StringBuilder messageString1 = new StringBuilder();
        messageString1.append(logoSSP);
        messageString1.append("^FO235, 220^A0,N,25,24^FDOCORRENCIA NR:").append(ocrnum).append(" - DATA: ").append(ocrdat);
    ...
    public static byte[] obterTermoManifestacaoOfendido(String ocrnum, String ocrdat, String nomeOfendido, String autoridadePM, String tipoManifestacao) {
        String retorno = null;
        StringBuilder messageString1 = new StringBuilder();
        messageString1.append(logoSSP);
        messageString1.append("^FO235, 220^A0,N,25,24^FDOCORRENCIA NR:").append(ocrnum).append(" - DATA: ").append(ocrdat);
